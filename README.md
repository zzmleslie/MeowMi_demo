...
| 🎨 渲染 | SpriteRenderer + 像素程序化纹理 | Undertale 像素风 |
| 🧠 AI 扩展 | REST API 接口预留 | 对接 LLM 智能体 |
| 🐍 数据获取 | Python 爬虫 | 从校园猫咪记录平台抓取数据 |
...
│       ├── Map/MapBuilder.cs             ← 🗺️ 地图动态构建+像素纹理
...
- 🐱 **喵喵喵喵** 团队——游戏策划、设计与开发
- 💡 灵感来源：南京大学【南雍猫札】的校园猫咪记录
- 🏫 校园参考：南京大学鼓楼校区 VR 全景 (vr.nju.edu.cn)
- 🎨 像素风格：Undertale RPG 美学 + 程序化像素纹理生成
